...
|---|---|---|
| Publish / update same URL, versions, gallery, share menu, permission prompt, emoji favicon, auto-open, live MCP connectors at view time | public docs + tool strings | ✅ at parity locally; public sharing links via GitHub Pages deploy (v0.7); viewer-identity connectors stay hosted-only |
