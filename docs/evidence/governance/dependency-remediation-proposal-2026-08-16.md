...
Status: proposal only; no dependency or license disposition has been approved or applied.
...
dispositions. Every selection remains pending maintainer approval.

| Package and dependency path | Installed license evidence | Proposed branch |
| --- | --- | --- |
| `mermaid@11.16.1 > khroma@2.1.0` | `node_modules/khroma/license`, SHA-256 `66b333b0f66759a0b710459e03f7029abe17f4358114a128d2c972e642961b49` | MIT |
| `mermaid@11.16.1 > dompurify@3.4.13` | `node_modules/dompurify/LICENSE`, SHA-256 `cfc7749b96f63bd31c3c42b5c471bf756814053e847c10f3eb003417bc523d30` | Apache-2.0 |
| `@opencode-ai/plugin@1.18.18 > @ai-sdk/provider@3.0.8 > json-schema@0.4.0` | `node_modules/json-schema/LICENSE`, SHA-256 `4e053c510d6f3e4724213a292c65142df68d069c40f558582bc4270914e16f77` | BSD-3-Clause |
...
convert that preference into a project disposition without human review.
