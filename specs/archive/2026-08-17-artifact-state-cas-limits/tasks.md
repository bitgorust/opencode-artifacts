# Tasks: Make mutable artifact state atomic and bounded

- [x] Confirm proposal validation and human approval.
- [x] Implement schema-2 state/comment/collection envelopes, validators, typed errors, and migration.
- [x] Implement atomic CAS/replay handling on the approved lifecycle transaction primitive.
