# Tasks: Separate OpenCode artifact permissions

- [x] Confirm proposal validation and human approval.
- [x] Add a permission state/property model covering every requested-scope subset and denial.
- [x] Add injectable no-write/no-runner tests for ask order, abort, and bounded metadata.
